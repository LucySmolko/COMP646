...
students <- read_excel("C:/Users/SmolkoL/OneDrive - DairyNZ Limited/Documents/data/students.xlsx")
students
...
penguins <- read_excel("C:/Users/SmolkoL/OneDrive - DairyNZ Limited/Documents/data/penguins.xlsx")
penguins
...
write_xlsx(bake_sale1, path="bake-sale1.xlsx")

read_excel("bake-sale1.xlsx")
#> # A tibble: 3 × 2
#>   item    quantity
#>   <chr>      <dbl>
#> 1 brownie       10
...
data <- read_csv(
  "heights.csv",
  col_names = c("income", "height", "gender", "education", "age", "race"),
  skip = 1,
  col_types = "ddcddc",
  na = c("", "N/A")
)
...
students2 <- read_sheet(students_sheet_id)
students2
